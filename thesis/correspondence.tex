...
Recall from Section \ref{sec:background_spectral} that a subset of vertices is degree homogenous if each vertex in the set has the same degree. 
...
\note{Will include this after the proof is sorted}
